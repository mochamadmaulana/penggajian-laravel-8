@extends('layout.main-accounting', ['title' => 'Detail Karyawan'])
        ...
        <div class="card-header p-2">
            <div class="row">
                ...
                <div class="col-lg-2 my-auto">
                    <a class="btn btn-sm btn-danger float-right" href="{{ route('accounting.karyawan') }}"><i class="fas fa-undo"></i> Kembali</a>
                </div>
            </div>
        </div><!-- /.card-header -->
        <div class="card-body">
            <div class="tab-content">
                ...
                <div class="tab-pane" id="slipGaji">
                    <table id="tableSlipGaji" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <?php $no=1; foreach ($slip_gajis as $slip_gaji) : ?>
                                <tr>
                                    <td>{{ $no++ }}</td>
                                    <td>{{ $slip_gaji->periode->periode }}</td>
